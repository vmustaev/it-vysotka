                    ...
                    <div className="championship-info">
                        ...
                        <div className="championship-info-block">
                            ...
                            <p className="info-block-text" style={{ marginTop: '12px' }}>
                                Участникам предлагаются три задачи, направленные на проверку углублённых знаний содержательной линии «Программирование» по предмету «Информатика». На решение задач отводится 2 часа 30 минут.
                            </p>
                            <p className="info-block-text" style={{ marginTop: '12px' }}>
