...
- **Отметка присутствия**: просмотр участников по кабинетам, индивидуальная и массовая отметка присутствия
- **Фильтрация**: по кабинетам и поиск по ФИО, школе, команде
- **Статистика в реальном времени**: общая явка, присутствующие/отсутствующие по кабинетам
...
│       │   │   └── volunteer/ # Страницы панели волонтера
...
- `GET /api/volunteer/attendance/statistics` - Статистика по присутствию
...
Основные модели:
- **User** - пользователи (участники, администраторы и волонтеры)
- **Team** - команды
- **School** - школы
- **Room** - аудитории
...
- **participant** - обычный участник чемпионата (по умолчанию)
- **admin** - администратор с полным доступом к панели управления
- **volunteer** - волонтер для отметки присутствия участников

Для добавления роли волонтера в существующую базу данных см. `VOLUNTEER_ROLE_MIGRATION.md`
...
Проект разработан **Мустаевым Венером Фанисовичем** и **Якшибаевым Даниром Ильдаровичем** в рамках выполнения комплексной выпускной квалификационной работы для кафедры ВТИК (Вычислительной техники и инженерной кибернетики) УГНТУ.

**Распределение работы:**
- **Якшибаев Данир Ильдарович** (83 функции): пользовательская часть приложения (регистрация, авторизация, личный кабинет, команды, публичные страницы, компоненты интерфейса) и панель волонтера (отметка присутствия, редактирование участников, статистика)
- **Мустаев Венер Фанисович** (102 функции): административная часть приложения (управление участниками, аудиториями, рассадкой, сертификатами, файлами, настройками, результатами, волонтерами, резервное копирование)

Подробное распределение функций см. в файле `РАБОТА_ВКР.md`
